...
Primitive raytracer::primitives::scale(const double sx, const double sy, const double sz, Primitive child)
{
    return transform(transformations::scale(sx, sy, sz), child);
}
