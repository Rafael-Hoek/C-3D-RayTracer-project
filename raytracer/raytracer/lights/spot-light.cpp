...
namespace
{
	...
	public:
		...
		SpotLight(const Point3D& position, const Vector3D& direction, math::Angle angle, const imaging::Color& color)
...
LightSource raytracer::lights::spot(const Point3D& position, const Vector3D& direction, math::Angle angle, const imaging::Color& color)
{
